...
<span style="font-size: 24px; font-weight: bold;">🌟 **[SQL Project : 택배 물류량과 사회적 요인 간의 관계 분석]**</span>
...
<span style="font-size: 24px; font-weight: bold;">🌟 **[수자원 공모전 Project : SPI6를 활용한 미래 가뭄 예측 시스템]**</span>
...
<span style="font-size: 24px; font-weight: bold;">🌟 **[세종시 공모전 Project : 세종엔에서 만나는 AI와 빅데이터를 활용한 개인 맞춤형 병원 · 음식점 추천 시스템]**</span>
...
<span style="font-size: 24px; font-weight: bold;">🌟 **[파이썬 데이터 분석 Project : 스낵시장의 트랜드와 소비자 요구]**</span>
...
<span style="font-size: 24px; font-weight: bold;">🌟 **[파이썬 딥러닝 Project : 음성 · 텍스트 기반 감정 숏폼 콘텐츠 제작]**</span>
